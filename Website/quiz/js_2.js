...
const quizData = [
{
    ...
    correct: "b",
    explanation: "In the second paragraph, it is said that 'Thunderstorms can produce lightning, thunder, rain, sleet, hail, or even snow' which makes this statement False.",
},
{
    ...
    correct: "c",
    explanation: "The last paragraph states that the eye can be anywhere from 2 to 200 miles in diameter.",
},
{
    ...
    d: "None of the above",
    correct: "a",
    explanation: "The 3rd Paragraph states that a Tornado is a type of storm that causes a watersprout when formed over the ocean.",
},
{
    ...
    d: "Thunderstorm",
    correct: "d",
    explanation: "It is states in Paragraph 2 that thunderstorms are the most common kind of storms.",
},
];
